...
a = Mahasiswa('Ika',10,'Sukoharjo',240000)
b = Mahasiswa('Budi',51,'Sragen',230000)
c = Mahasiswa('Ahmad',2,'Surakarta',250000)
d = Mahasiswa('Chandra',18,'Surakarta',235000)
e = Mahasiswa('Eka',4,'Boyolali',240000)
f = Mahasiswa('Fandi',31,'Salatiga',250000)
g = Mahasiswa('Deni',13,'Klaten',245000)
h = Mahasiswa('Galuh',5,'Wonogiri',245000)
i = Mahasiswa('Janto',23,'Klaten',245000)
j = Mahasiswa('Hasan',64,'Karanganyar',270000)
k = Mahasiswa('Khalid',29,'Purwodadi',230000)
