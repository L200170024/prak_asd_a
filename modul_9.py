...
A=simpulbiner('Pati')
B=simpulbiner('Rembang')
C=simpulbiner('Kudus')
D=simpulbiner('Jepara')
E=simpulbiner('Blora')
F=simpulbiner('Solo')
G=simpulbiner('Tangerang')
H=simpulbiner('Ternate')
I=simpulbiner('Papua')
...
print('Ukuran dari Binary Tree :', size(A))
print('')
print('Tinggi maksimal dari Binary Tree :', maxDepth(A))
print('')
cetakdatadanlevel(A)
